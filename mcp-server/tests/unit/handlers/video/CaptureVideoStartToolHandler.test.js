...
import { CaptureVideoStartToolHandler } from '../../../../src/handlers/video/CaptureVideoStartToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('CaptureVideoStartToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new CaptureVideoStartToolHandler(mockConnection);
  });
