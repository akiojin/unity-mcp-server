...
import { CaptureVideoStatusToolHandler } from '../../../../src/handlers/video/CaptureVideoStatusToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('CaptureVideoStatusToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new CaptureVideoStatusToolHandler(mockConnection);
  });

  describe('constructor', () => {
    it('should initialize with correct properties', () => {
      assert.equal(handler.name, 'video_capture_status');
