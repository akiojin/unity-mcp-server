...
import { VideoCaptureForToolHandler } from '../../../../src/handlers/video/VideoCaptureForToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('VideoCaptureForToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new VideoCaptureForToolHandler(mockConnection);
  });

  describe('constructor', () => {
    it('should initialize with correct properties', () => {
      assert.equal(handler.name, 'video_capture_for');
