...
import { SetUIElementValueToolHandler } from '../../../../src/handlers/ui/SetUIElementValueToolHandler.js';
import { BaseToolHandler } from '../../../../src/handlers/base/BaseToolHandler.js';

describe('SetUIElementValueToolHandler', () => {
    let handler;
    ...
    beforeEach(() => {
        ...
        handler = new SetUIElementValueToolHandler(mockUnityConnection);
    });
