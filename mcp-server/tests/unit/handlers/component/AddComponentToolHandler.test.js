...
import { AddComponentToolHandler } from '../../../../src/handlers/component/AddComponentToolHandler.js';
...
describe('AddComponentToolHandler', () => {
  let handler;
  let mockConnection;

  beforeEach(() => {
    mockConnection = new MockUnityConnection();
    handler = new AddComponentToolHandler(mockConnection);
  });
