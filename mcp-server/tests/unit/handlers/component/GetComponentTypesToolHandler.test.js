...
import { GetComponentTypesToolHandler } from '../../../../src/handlers/component/GetComponentTypesToolHandler.js';
...
describe('GetComponentTypesToolHandler', () => {
  let handler;
  let mockConnection;

  beforeEach(() => {
    mockConnection = new MockUnityConnection();
    handler = new GetComponentTypesToolHandler(mockConnection);
  });
