...
import { ModifyComponentToolHandler } from '../../../../src/handlers/component/ModifyComponentToolHandler.js';
...
describe('ModifyComponentToolHandler', () => {
  let handler;
  let mockConnection;

  beforeEach(() => {
    mockConnection = new MockUnityConnection();
    handler = new ModifyComponentToolHandler(mockConnection);
  });
