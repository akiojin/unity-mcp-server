...
import { ComponentRemoveToolHandler } from '../../../../src/handlers/component/ComponentRemoveToolHandler.js';
...
describe('ComponentRemoveToolHandler', () => {
  let handler;
  let mockConnection;

  beforeEach(() => {
    mockConnection = new MockUnityConnection();
    handler = new ComponentRemoveToolHandler(mockConnection);
  });
