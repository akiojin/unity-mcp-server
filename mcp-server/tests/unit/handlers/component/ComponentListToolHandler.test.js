...
import { ComponentListToolHandler } from '../../../../src/handlers/component/ComponentListToolHandler.js';
...
describe('ComponentListToolHandler', () => {
  let handler;
  let mockConnection;

  beforeEach(() => {
    mockConnection = new MockUnityConnection();
    handler = new ComponentListToolHandler(mockConnection);
  });
