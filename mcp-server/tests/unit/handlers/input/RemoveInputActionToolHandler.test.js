...
import { RemoveInputActionToolHandler } from '../../../../src/handlers/input/RemoveInputActionToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('RemoveInputActionToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new RemoveInputActionToolHandler(mockConnection);
  });

  describe('constructor', () => {
    it('should initialize with correct properties', () => {
      assert.equal(handler.name, 'remove_input_action');
