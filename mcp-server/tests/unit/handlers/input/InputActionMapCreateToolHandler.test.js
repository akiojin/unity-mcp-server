...
import { InputActionMapCreateToolHandler } from '../../../../src/handlers/input/InputActionMapCreateToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('InputActionMapCreateToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new InputActionMapCreateToolHandler(mockConnection);
  });
