...
import { RemoveInputBindingToolHandler } from '../../../../src/handlers/input/RemoveInputBindingToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('RemoveInputBindingToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new RemoveInputBindingToolHandler(mockConnection);
  });
  ...
  describe('execute', () => {
    it('should execute successfully with required parameters', async () => {
      ...
      assert.equal(mockConnection.sendCommand.mock.calls[0].arguments[0], 'input_binding_remove');
