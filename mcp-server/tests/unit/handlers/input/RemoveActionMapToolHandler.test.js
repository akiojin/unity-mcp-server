...
import { RemoveActionMapToolHandler } from '../../../../src/handlers/input/RemoveActionMapToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('RemoveActionMapToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new RemoveActionMapToolHandler(mockConnection);
  });
