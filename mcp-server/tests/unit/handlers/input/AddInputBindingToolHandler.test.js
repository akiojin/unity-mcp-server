...
import { AddInputBindingToolHandler } from '../../../../src/handlers/input/AddInputBindingToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('AddInputBindingToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new AddInputBindingToolHandler(mockConnection);
  });
