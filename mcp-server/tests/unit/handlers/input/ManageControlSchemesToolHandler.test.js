...
import { ManageControlSchemesToolHandler } from '../../../../src/handlers/input/ManageControlSchemesToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('ManageControlSchemesToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new ManageControlSchemesToolHandler(mockConnection);
  });
