...
import { TouchSimulationHandler } from '../../../../src/handlers/input/TouchSimulationHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('TouchSimulationHandler', () => {
  let handler;
  let mockConnection;

  beforeEach(() => {
    mockConnection = createMockUnityConnection({ sendCommandResult: { success: true } });
    handler = new TouchSimulationHandler(mockConnection);
  });
