...
import { CreateCompositeBindingToolHandler } from '../../../../src/handlers/input/CreateCompositeBindingToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('CreateCompositeBindingToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new CreateCompositeBindingToolHandler(mockConnection);
  });
