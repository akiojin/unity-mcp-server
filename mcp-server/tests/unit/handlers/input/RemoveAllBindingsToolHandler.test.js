...
import { RemoveAllBindingsToolHandler } from '../../../../src/handlers/input/RemoveAllBindingsToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('RemoveAllBindingsToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new RemoveAllBindingsToolHandler(mockConnection);
  });
