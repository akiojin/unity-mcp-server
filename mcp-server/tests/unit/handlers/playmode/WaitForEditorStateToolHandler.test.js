...
import { WaitForEditorStateToolHandler } from '../../../../src/handlers/playmode/WaitForEditorStateToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('WaitForEditorStateToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new WaitForEditorStateToolHandler(mockConnection);
  });
