...
import { GetCommandStatsToolHandler } from '../../../../src/handlers/system/GetCommandStatsToolHandler.js';
import { createMockUnityConnection } from '../../../utils/test-helpers.js';

describe('GetCommandStatsToolHandler', () => {
  let handler;
  let mockConnection;
  ...
  beforeEach(() => {
    ...
    handler = new GetCommandStatsToolHandler(mockConnection);
  });
