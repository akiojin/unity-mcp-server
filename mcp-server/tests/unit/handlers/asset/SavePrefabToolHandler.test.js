...
import { SavePrefabToolHandler } from '../../../../src/handlers/asset/SavePrefabToolHandler.js';
...
describe('SavePrefabToolHandler', () => {
  let handler;
  let mockConnection;

  beforeEach(() => {
    mockConnection = new MockUnityConnection();
    handler = new SavePrefabToolHandler(mockConnection);
  });
