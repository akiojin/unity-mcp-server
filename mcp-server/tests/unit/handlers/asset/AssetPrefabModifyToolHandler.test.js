...
import { AssetPrefabModifyToolHandler } from '../../../../src/handlers/asset/AssetPrefabModifyToolHandler.js';
import { BaseToolHandler } from '../../../../src/handlers/base/BaseToolHandler.js';

describe('AssetPrefabModifyToolHandler', () => {
  let handler;
  ...
  beforeEach(() => {
    ...
    handler = new AssetPrefabModifyToolHandler(mockUnityConnection);
  });
  ...
  describe('initialization', () => {
    ...
    it('should have correct tool name', () => {
      assert.strictEqual(handler.name, 'modify_prefab');
    });
  ...
  describe('getDefinition', () => {
    it('should return correct tool definition', () => {
      ...
      assert.strictEqual(definition.name, 'modify_prefab');
  ...
  describe('validate', () => {
    it('should require prefabPath', () => {
      assert.throws(() => handler.validate({ modifications: {} }), {
        message: 'Missing required parameter: prefabPath'
      });
    });

    it('should require modifications', () => {
      assert.throws(() => handler.validate({ prefabPath: 'Assets/Test.prefab' }), {
  ...
  describe('execute', () => {
    ...
    it('should modify prefab without applying to instances', async () => {
      ...
      assert.deepStrictEqual(
        mockUnityConnection.sendCommand.mock.calls[0].arguments[1].applyToInstances,
        false
      );
      assert.deepStrictEqual(result, mockResponse);
    });
