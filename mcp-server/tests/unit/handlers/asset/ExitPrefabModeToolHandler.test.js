...
import { ExitPrefabModeToolHandler } from '../../../../src/handlers/asset/ExitPrefabModeToolHandler.js';
...
describe('ExitPrefabModeToolHandler', () => {
  let handler;
  let mockConnection;

  beforeEach(() => {
    mockConnection = new MockUnityConnection();
    handler = new ExitPrefabModeToolHandler(mockConnection);
  });
