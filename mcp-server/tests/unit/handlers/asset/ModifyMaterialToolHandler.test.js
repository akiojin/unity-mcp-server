...
import { ModifyMaterialToolHandler } from '../../../../src/handlers/asset/ModifyMaterialToolHandler.js';
import { BaseToolHandler } from '../../../../src/handlers/base/BaseToolHandler.js';

describe('ModifyMaterialToolHandler', () => {
    let handler;
    ...
    before(() => {
        ...
        handler = new ModifyMaterialToolHandler(mockUnityConnection);
    });
    ...
    describe('initialization', () => {
        ...
        it('should have correct tool name', () => {
            assert.equal(handler.name, 'asset_material_modify');
        });
    ...
    describe('getDefinition', () => {
        it('should return correct tool definition', () => {
            ...
            assert.equal(definition.name, 'asset_material_modify');
    ...
    describe('validate', () => {
        it('should require materialPath', () => {
            assert.throws(
                () => handler.validate({ properties: { _Color: [1, 0, 0, 1] } }),
        ...
        it('should require properties', () => {
            assert.throws(
                () => handler.validate({ materialPath: 'Assets/Test.mat' }),
