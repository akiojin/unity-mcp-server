...
import { OpenPrefabToolHandler } from '../../../../src/handlers/asset/OpenPrefabToolHandler.js';
...
describe('OpenPrefabToolHandler', () => {
  let handler;
  let mockConnection;

  beforeEach(() => {
    mockConnection = new MockUnityConnection();
    handler = new OpenPrefabToolHandler(mockConnection);
  });
