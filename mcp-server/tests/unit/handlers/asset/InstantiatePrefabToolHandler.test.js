...
import { InstantiatePrefabToolHandler } from '../../../../src/handlers/asset/InstantiatePrefabToolHandler.js';
import { BaseToolHandler } from '../../../../src/handlers/base/BaseToolHandler.js';

describe('InstantiatePrefabToolHandler', () => {
    let handler;
    ...
    beforeEach(() => {
        ...
        handler = new InstantiatePrefabToolHandler(mockUnityConnection);
    });
    ...
    describe('execute', () => {
        ...
        it('should instantiate prefab with parent and custom name', async () => {
            ...
            assert.deepStrictEqual(mockUnityConnection.sendCommand.mock.calls[0].arguments[1].parent, '/Environment');
            assert.deepStrictEqual(mockUnityConnection.sendCommand.mock.calls[0].arguments[1].name, 'Tree_01');
            assert.deepStrictEqual(result, mockResponse);
        });
