...
- **C# ファイル数**: 60,000+ ファイル
- **コードインデックス**: 380,000+ シンボル
- **パッケージ**: UniTask, VContainer, Google Mobile Ads SDK, NuGetForUnity など

コードインデックス（SQLite ベース）は大規模コードベースを効率的に処理し、数万ファイル規模でのシンボル検索・構造化編集を実現します。
