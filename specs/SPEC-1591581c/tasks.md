...
**ファイル**: `UnityMCPServer/Packages/unity-mcp-server/Editor/Handlers/ProfilerHandler.cs`
...
**ファイル**: `mcp-server/src/handlers/profiler/ProfilerStartToolHandler.js`
...
**ファイル**: `mcp-server/src/handlers/profiler/ProfilerStopToolHandler.js`
...
**ファイル**: `mcp-server/src/handlers/profiler/ProfilerStatusToolHandler.js`
...
**ファイル**: `mcp-server/src/handlers/profiler/ProfilerGetMetricsToolHandler.js`
...
**ファイル**: `mcp-server/src/handlers/index.js`
...
**ファイル**: `mcp-server/tests/integration/profiler/profiler-start.test.js`
...
**ファイル**: `mcp-server/tests/integration/profiler/profiler-stop.test.js`
...
**ファイル**: `mcp-server/tests/integration/profiler/profiler-status.test.js`
...
**ファイル**: `mcp-server/tests/integration/profiler/profiler-get-metrics.test.js`
...
**ファイル**: `mcp-server/tests/unit/handlers/profiler/*.test.js`
...
**ファイル**:
- `UnityMCPServer/Packages/unity-mcp-server/Editor/Handlers/ProfilerHandler.cs`
- `mcp-server/src/handlers/profiler/*.js`
