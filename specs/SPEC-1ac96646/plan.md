...
**技術アプローチ**:
- GitHub Actionsワークフローの調整（auto-merge, release, mcp-server-publish）
...
**シンプルさ**:
- プロジェクト数: 1（既存unity-mcp-serverリポジトリの拡張）✅
...
└── mcp-server-publish.yml # 現状維持: GitHub Releaseでnpm publish
