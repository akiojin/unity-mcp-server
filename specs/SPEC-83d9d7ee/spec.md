...
**作成日**: 2026-02-17  
**ステータス**: 実装完了  
**入力**: ユーザー説明: "unity-mcp-server を CLI 化し、Node.js から Rust へ置換。仕様と TDD も整備する。UPM同梱・Cargo配布・LSP同梱も行う"
...
- **FR-010**: Unity 側の主要公開名は `UnityMCPServer` を使用せず、`UnityCliBridge` 系名称へ統一する必要がある。
