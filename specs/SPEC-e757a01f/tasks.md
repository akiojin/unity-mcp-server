...
### Phase 3.1: セットアップ（未着手）

- [ ] **T101** [P] prebuilds/ディレクトリ構造作成
- [ ] **T102** [P] prebuildifyツール評価・選定
- [ ] **T103** [P] GitHub Actions用ビルドマトリクス設計

### Phase 3.2: テストファースト (TDD)（未着手）
...
- [ ] **T106** `scripts/ensure-better-sqlite3.mjs` - postinstallスクリプト実装
...
- [ ] **T107** [P] `.github/workflows/prebuild.yml` - CI用ビルドワークフロー
  ...
  - 実装: prebuildifyによるバイナリ生成
  - 実装: prebuilds/へのアーティファクト保存

- [ ] **T108** `package.json` - postinstall設定
