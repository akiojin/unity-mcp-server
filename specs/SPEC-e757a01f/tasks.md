...
- [x] R-003: search_scriptのアンカー解決への再利用可能性
  - 結果: search_script不要、indexOfで十分
...
- [x] DOC-001: CLAUDE.md更新（edit_script_snippet使用ガイドライン）
- [x] DOC-002: 使用例追加
...
- ✅ パフォーマンス: build_code_index < 1秒、get_code_index_status < 100ms
