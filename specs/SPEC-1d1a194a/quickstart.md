...
1. **unity-mcp-serverをインストール**:
   ```bash
   npm install -g @akiojin/unity-mcp-server@latest
   ```
...
1. **README.mdのTroubleshootingセクションを開く**:
   ```bash
   cat mcp-server/README.md | grep -A 20 "## Troubleshooting"
   ```
