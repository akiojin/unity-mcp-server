...
- ライブラリごとのCLI: ✅ `unity-mcp-server --help/--version`
...
5. **Core Implementation** (順次実行):
   - `mcp-server/src/core/server.js`修正:
...
6. **Documentation**:
   - `mcp-server/README.md`にトラブルシューティングセクション追加
