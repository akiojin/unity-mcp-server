 ...
 *   --output UnityMCPServer/Assets/Scripts/Generated
 */
...
function parseArgs() {
  ...
  const config = {
    modules: 100,
    filesPerModule: 1000,
    output: path.join(PROJECT_ROOT, 'UnityMCPServer/Assets/Scripts/Generated'),
    dryRun: false,
    verbose: false
  }
...
async function generate(config) {
  ...
  console.log('   2. Run: mcp__unity-mcp-server__build_code_index')
  console.log('   3. Verify with: mcp__unity-mcp-server__get_code_index_status\n')
}
