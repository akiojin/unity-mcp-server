...
4. **Publish** (tag trigger): Build csharp-lsp, npm publish, OpenUPM auto-detect, backmerge to `develop`
...
4. Publish: csharp-lspビルド、npm publish、OpenUPM検出
