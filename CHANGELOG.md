...
* **mcp-server:** add Library/PackageCache to search_script scope ([e797f5b](https://github.com/akiojin/unity-mcp-server/commit/e797f5b9b1226e3ec726cd66580c0ba7310350a5))
...
* **script-tools:** replace LSP with file-based search in find_script_refs ([cc99ee0](https://github.com/akiojin/unity-mcp-server/commit/cc99ee0e15e4ff7e0fb25ed3da905d9d1c85c375))
* **script-tools:** replace LSP with file-based search in find_script_refs ([b74f081](https://github.com/akiojin/unity-mcp-server/commit/b74f081fb8e4b4c85a2461b74150c68e538cf19b))
...
* **code-index:** use Worker Thread for build_code_index to prevent blocking ([467e2a1](https://github.com/akiojin/unity-mcp-server/commit/467e2a18b8cd5edf5b97aef66ea95449201394b5))
* **code-index:** use Worker Thread for build_code_index to prevent blocking ([11d54ea](https://github.com/akiojin/unity-mcp-server/commit/11d54ea7dd0674d3dd461880cfa9b3b599313666))
...
* **code-index:** remove expensive file scan from get_code_index_status ([ac912e2](https://github.com/akiojin/unity-mcp-server/commit/ac912e2253f726f63d0dc373379b0209e86c332e))
...
* **script:** normalize line endings in edit_script_snippet for Issue [#97](https://github.com/akiojin/unity-mcp-server/issues/97) ([27f4650](https://github.com/akiojin/unity-mcp-server/commit/27f465070ca55e53df7b5845b9990d19d58e63da))
