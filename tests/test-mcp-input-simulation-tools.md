...
チェックリスト（Markdown）
- [ ] U130-01: input_keyboard（type: "hello"）
- [ ] U130-02: input_mouse（move → click）
- [ ] U130-03: input_gamepad / input_touch（簡易）
- [ ] U130-E01: 不正キーで fail
- [ ] U130-E02: 未知 action で fail

## 正常系

- U130-01: `input_keyboard`（`action=type`, `text="hello"`）→ 成功
- U130-02: `input_mouse`（move → click）→ 成功
- U130-03: `input_gamepad` / `input_touch` → 成功
